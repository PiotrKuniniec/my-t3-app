const Footer = () => {
  return (
    <div className="flex w-full items-center justify-center pt-52">
      <div className="flex w-full flex-col px-4 text-primary md:w-2/3">
        <div className="w-full font-bold">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block xl:inline">Do you have any questions?</span>
            <span className="block text-primary">Happy to help!</span>
          </h1>
        </div>
        <div className="mt-8 flex flex-col md:flex-row md:justify-between">
          <p className="w-full text-gray-400 md:w-2/3">
            We are putting our heart and soul into creating the best experience
            for your dog. If you have any questions, please don&apos;t hesitate
            to contact us.
          </p>
          <div className="w-44 pt-6 md:pt-0">
            <button
              type="button"
              className="inline-flex w-full min-w-[120px] max-w-[120px] justify-center rounded-md bg-primary px-5 py-3 text-sm text-white shadow-sm hover:bg-secondary"
            >
              Contact us
            </button>
          </div>
        ...
        <div className="flex flex-col">
          <div className="mb-12 mt-24 flex flex-row justify-between">
            <a className="hidden cursor-pointer uppercase text-gray-500 hover:text-white md:block">
              About
            </a>
            <a className="hidden cursor-pointer uppercase text-gray-500 hover:text-white md:block">
              Services
